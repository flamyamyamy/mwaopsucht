...
export async function execute(interaction) {
  ...
  collector.on("collect", async (i) => {
    ...
    const updateOpts = {
      embeds: [newEmbed],
      components: [buildSelectRow(query, newDays)],
    };
...
/**
 * Rendert einen Preisverlauf-Chart im Stil des Screenshots:
...
function buildSelectRow(query, days) {
